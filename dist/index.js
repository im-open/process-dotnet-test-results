  ...
  "src/utils.js"(exports2, module2) {
    ...
    async function transformTrxToJson(filePath) {
      ...
      const options = {
        ...
        arrayMode: false,
        attrValueProcessor: (val, _attrName) => he.decode(val, {
...
var require_markup = __commonJS({
  ...
  `;
    ...
    function getTestCounters(testData) {
      ...
      extraProps += getTableRowIfHasValue("PassedButRunAborted:", testData.TrxData.TestRun.ResultSummary.Counters._passedButRunAborted);
  ...
  try {
    ...
    if (markupForComment.length > 0 && shouldCreatePRComment) {
      ...
      if (markupComment.length > characterLimit) {
        core.info(`Truncating markup data due to character limit exceeded for github api.  Markup data length: ${markupComment.length}/${characterLimit}`);
